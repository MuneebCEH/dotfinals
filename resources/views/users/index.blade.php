...
@section('content')
    <div class="space-y-8 animate-on-load">
        ...
        <div
            ...
            <!-- Search (AJAX) -->
            <div
                class="px-8 pt-6 pb-4 border-b border-gray-200/50 dark:border-gray-700/50 bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl">
                <form id="usersFilterForm" method="GET" action="{{ route('users.index') }}"
                    ...
                    <div class="relative flex-1">
                        ...
                        <input id="userSearchInput" type="text" name="q" value="{{ request('q') }}"
                            ...
                            class="pl-10 w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700
                                      bg-white dark:bg-gray-800 text-gray-900 dark:text-white
                                      focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    </div>

                    <button type="submit"
                        class="px-6 py-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-xl shadow hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">
                        Search
                    </button>

                    @if (request()->has('q'))
                        <a id="clearUserFilters" href="{{ route('users.index') }}"
                            class="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 transition">
                            Clear
                        </a>
                    @endif
                </form>
            ...
            <div class="relative" id="usersTableCard">
                ...
                <!-- Results container (AJAX replaces this inner HTML) -->
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-8 py-16 text-center">
                                                <div class="text-center">
                                                    ...
                                                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">No
                                                        users found
                                                    </h3>
                                                    <p class="text-gray-600 dark:text-gray-400 mb-8">Get started by creating a
                                                        new user
                                                        account.</p>
                                                    <a href="{{ route('users.create') }}"
                                                        class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
            ...
            <div id="deleteModal"
                class="fixed inset-0 bg-gray-600/75 backdrop-blur-sm overflow-y-auto h-full w-full hidden z-50">
                <div

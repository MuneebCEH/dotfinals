            ...
            <div id="autoCheckoutBanner"
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-amber-700 dark:text-amber-200 text-sm">Close/reload detected â€” your session was
                            safely ended.</p>
                    </div>
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">
                                                    Youâ€™ll be checked in automatically the next time you log in.
                                                </p>
                                            </div>
                                        </div>
                                        <a href="{{ route('attendance.history') }}"
                        ...
                        @else
                            ...
                            <div class="flex-1 flex items-start gap-3">
                                ...
                                <p class="text-gray-700 dark:text-gray-300">
                                    Youâ€™ll be checked in automatically now. Closing your last tab or logging out will check
                        ...
                        @forelse ($recentLeads as $lead)
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                    {{ $fullName !== '' ? $fullName : 'â€”' }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                    {{ $cityState !== '' ? $cityState : 'â€”' }}</td>
                                ...
                                @endif
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                    {{ optional($lead->created_at)->diffForHumans() ?? 'â€”' }}</td>
                            </tr>
                        @empty
                            <tr>
...
@push('scripts')
    ...
    {{-- <script>
        (function() {
            ...
            // decrement and if last â†’ beacon logout
            let closing = false;
            ...
            document.addEventListener('DOMContentLoaded', function() {
                try {
                    ...
                    if (ts && (Date.now() - ts) < 10 * 60 * 1000) {
                        ...
                        // clear it so we donâ€™t show forever

...
<head>
    ...
    <title>{{ config('app.name', 'Leads Management Portal') }} - Register</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            @if($errors->any())
                <div class="bg-danger-50 border border-danger-200 text-danger-800 px-4 py-3 rounded-md">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input id="name" name="name" type="text" autocomplete="name" required value="{{ old('name') }}" 
                            class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm bg-white dark:bg-gray-700"
